...
public class ConnectionInfo {
    ...
    public ConnectionInfo(String component, String dbType, String host, int port, String databaseName) {
        this.dbType = dbType;
    ...
    public ConnectionInfo(String component, String dbType, String hosts, String databaseName) {
        this.dbType = dbType;
