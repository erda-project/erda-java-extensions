...
package io.terminus.spot.plugin.jdbc.connectionurl.parser;
...
public class H2URLParser extends AbstractURLParser {
    ...
    public ConnectionInfo parse() {
        ...
        if (databaseNameRangeIndex != null) {
            return new ConnectionInfo(Constants.Tags.COMPONENT_H2, H2_DB_TYPE, LOCALHOST, -1, fetchDatabaseNameFromURL(databaseNameRangeIndex));
        }
        ...
        if (hostAndPort.length == 1) {
            return new ConnectionInfo(Constants.Tags.COMPONENT_H2, H2_DB_TYPE, hostAndPort[0], DEFAULT_PORT, fetchDatabaseNameFromURL());
        } else {
            return new ConnectionInfo(Constants.Tags.COMPONENT_H2, H2_DB_TYPE, hostAndPort[0], Integer.valueOf(hostAndPort[1]), fetchDatabaseNameFromURL());
        }
    }
