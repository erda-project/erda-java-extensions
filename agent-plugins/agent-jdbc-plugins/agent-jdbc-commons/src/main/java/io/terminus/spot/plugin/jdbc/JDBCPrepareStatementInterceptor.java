...
import io.terminus.spot.plugin.jdbc.trace.SWPreparedStatement;
...
public class JDBCPrepareStatementInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(IMethodInterceptContext context,
        ...
        return new SWPreparedStatement((Connection)objInst, (PreparedStatement)ret, (ConnectionInfo)objInst.getDynamicField(), (String)context.getArguments()[0]);
    }

    @Override public void handleMethodException(IMethodInterceptContext context, Throwable t) {
