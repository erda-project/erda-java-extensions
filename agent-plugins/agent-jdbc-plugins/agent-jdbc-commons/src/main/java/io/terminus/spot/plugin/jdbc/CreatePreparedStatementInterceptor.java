...
public class CreatePreparedStatementInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(IMethodInterceptContext context, Object ret) throws Throwable {
        if (ret instanceof EnhancedInstance) {
            ((EnhancedInstance)ret).setDynamicField(new StatementEnhanceInfos((ConnectionInfo)context.getInstance().getDynamicField(), (String)context.getArguments()[0], "PreparedStatement"));
        }
        return ret;
    }
