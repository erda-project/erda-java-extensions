...
package cloud.erda.agent.plugin.http.v9.define;
...
public class DefaultHttpClientInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
     ...
     * Intercept class.
     */
    private static final String INTERCEPT_CLASS = "cloud.erda.agent.plugin.http.v9.DefaultHttpClientInterceptor";
