...
public class DubboInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(IMethodInterceptContext context, MethodInterceptResult result) {
        ...
        span.tag(Constants.Tags.PEER_SERVICE, invoker.getInterface().getName());
    ...
    /**
     * Format operation name. e.g. io.terminus.spot.plugin.test.Test.test(String)
     *
    ...
    /**
     * Format request url. e.g. dubbo://127.0.0.1:20880/io.terminus.spot.plugin.test.Test.test(String).
     *
     * @return request url.
     */
