...
/**
 * {@link FailedCallbackMatch} match the class that inherited <code>org.springframework.util.concurrent
 * .FailureCallback</code> and not inherited <code>org.springframework.util.concurrent.SuccessCallback</code>
 *
 * @author zhangxin
 */
