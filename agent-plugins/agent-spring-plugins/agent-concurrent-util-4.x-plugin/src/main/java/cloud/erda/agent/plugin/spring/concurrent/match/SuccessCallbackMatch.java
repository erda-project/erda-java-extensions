...
/**
 * {@link SuccessCallbackMatch} match the class that inherited <code>org.springframework.util.concurrent
 * .SuccessCallback</code> and not inherited <code>org.springframework.util.concurrent.FailureCallback</code>
 *
 * @author zhangxin
 */
