...
package io.terminus.spot.plugin.spring.concurrent.define;

import org.apache.skywalking.apm.agent.core.plugin.interceptor.ConstructorInterceptPoint;
import org.apache.skywalking.apm.agent.core.plugin.interceptor.InstanceMethodsInterceptPoint;
import org.apache.skywalking.apm.agent.core.plugin.interceptor.enhance.ClassInstanceMethodsEnhancePluginDefine;
import org.apache.skywalking.apm.agent.core.plugin.match.ClassMatch;
import io.terminus.spot.plugin.spring.concurrent.match.SuccessCallbackMatch;
...
public class SuccessCallbackInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String SUCCESS_CALLBACK_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.concurrent.SuccessCallbackInterceptor";
