 ...
 *
 * <code>org.springframework.http.client.RestRequestInterceptor</code> set {@link URI} to
...
public class RestTemplateInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DO_EXECUTE_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.async.RestExecuteInterceptor";
    ...
    private static final String CREATE_REQUEST_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.async.RestRequestInterceptor";
