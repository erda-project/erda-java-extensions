...
package io.terminus.spot.plugin.spring.resttemplate.sync.define;
...
public class RestTemplateInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DO_EXECUTE_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.sync.RestExecuteInterceptor";

    private static final String HANDLE_REQUEST_METHOD_NAME = "handleResponse";
    private static final String HANDLE_REQUEST_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.sync.RestResponseInterceptor";
    ...
    private static final String CREATE_REQUEST_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.sync.RestRequestInterceptor";
    ...
    protected InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        return new InstanceMethodsInterceptPoint[] {
            ...
            new InstanceMethodsInterceptPoint() {
                ...
                @Override
                public String getMethodsInterceptor() {
                    return HANDLE_REQUEST_INTERCEPTOR;
                }
