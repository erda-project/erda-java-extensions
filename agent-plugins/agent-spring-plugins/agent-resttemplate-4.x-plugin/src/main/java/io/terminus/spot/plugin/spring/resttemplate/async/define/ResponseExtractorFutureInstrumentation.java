...
package io.terminus.spot.plugin.spring.resttemplate.async.define;
...
import io.terminus.spot.plugin.spring.resttemplate.async.ResponseCallBackInterceptor;
...
public class ResponseExtractorFutureInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ADD_CALLBACK_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.async.ResponseCallBackInterceptor";

    private static final String GET_METHOD_NAME = "get";
    private static final String GET_METHOD_INTERCEPTOR
        = "io.terminus.spot.plugin.spring.resttemplate.async.FutureGetInterceptor";
