...
package cloud.erda.agent.plugin.spring.resttemplate.sync.define;
...
public class RestTemplateInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DO_EXECUTE_INTERCEPTOR
            = "cloud.erda.agent.plugin.spring.resttemplate.sync.RestExecuteInterceptor";
    ...
    private static final String HANDLE_REQUEST_INTERCEPTOR
            = "cloud.erda.agent.plugin.spring.resttemplate.sync.RestResponseInterceptor";
    ...
    private static final String CREATE_REQUEST_INTERCEPTOR
            = "cloud.erda.agent.plugin.spring.resttemplate.sync.RestRequestInterceptor";
