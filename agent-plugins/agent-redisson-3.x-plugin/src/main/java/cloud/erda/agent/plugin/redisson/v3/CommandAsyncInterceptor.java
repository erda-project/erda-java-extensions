 ...
 */
public class CommandAsyncInterceptor implements InstanceMethodsAroundInterceptor {

    private final static ILog logger = LogManager.getLogger(CommandAsyncInterceptor.class);
