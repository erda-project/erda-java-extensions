...
package io.terminus.spot.plugin.rocketmq.v4.define;
...
public class SendCallbackInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ON_SUCCESS_INTERCEPTOR = "io.terminus.spot.plugin.rocketmq.v4.OnSuccessInterceptor";
    private static final String ON_EXCEPTION_INTERCEPTOR = "io.terminus.spot.plugin.rocketmq.v4.OnExceptionInterceptor";
