...
public class MQClientAPIImplInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String SEND_MESSAGE_INTERCEPTOR = "io.terminus.spot.plugin.rocketmq.v4.MessageSendInterceptor";
    private static final String UPDATE_NAME_SERVER_INTERCEPT
        = "io.terminus.spot.plugin.rocketmq.v4.UpdateNameServerInterceptor";
