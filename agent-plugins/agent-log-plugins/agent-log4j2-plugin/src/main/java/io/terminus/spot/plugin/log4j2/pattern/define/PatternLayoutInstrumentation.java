package io.terminus.spot.plugin.log4j2.pattern.define;
...
public class PatternLayoutInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "io.terminus.spot.plugin.log4j2.pattern.PatternLayoutInterceptor";
