...
package cloud.erda.agent.plugin.lettuce.v5.define;
...
public class RedisClusterClientInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String REDIS_CLUSTER_CLIENT_CONSTRUCTOR_INTERCEPTOR_CLASS = "cloud.erda.agent.plugin.lettuce.v5.RedisClusterClientConstructorInterceptor";
