...
package cloud.erda.agent.plugin.httpasyncclient.v4.define;
 ...
 * TracerSnapshot} object to be continued in "completed" method.that is mean the
...
public class SessionRequestInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String CONSTRUCTOR_INTERCEPTOR_CLASS
            = "cloud.erda.agent.plugin.httpasyncclient.v4.SessionRequestConstructorInterceptor";
    private static final String SUCCESS_INTERCEPTOR_CLASS
            = "cloud.erda.agent.plugin.httpasyncclient.v4.SessionRequestCompleteInterceptor";
    private static final String FAIL_INTERCEPTOR_CLASS
            = "cloud.erda.agent.plugin.httpasyncclient.v4.SessionRequestFailInterceptor";
