...
public class RealCallInterceptor implements InstanceMethodsAroundInterceptor, InstanceConstructorInterceptor {
    ...
    /**
     * Get the {@link okhttp3.Request} from {@link EnhancedInstance}, then create {@link Span} and set host, port, kind,
     * component, url from {@link okhttp3.Request}. Through the reflection of the way, set the http header of context
     * data into {@link okhttp3.Request#headers}.
     *
     * @param context
