...
package io.terminus.spot.plugin.jedis.v2;
...
public class JedisConstructorWithStringArgInterceptorTest {
    ...
    public void onConstruct() throws Exception {
        ...
        verify(enhancedInstance, times(1)).setDynamicField("127.0.0.1:6379");
    }
    ...
    public void onConstructWithPort() {
        ...
        verify(enhancedInstance, times(1)).setDynamicField("127.0.0.1:16379");
    }
