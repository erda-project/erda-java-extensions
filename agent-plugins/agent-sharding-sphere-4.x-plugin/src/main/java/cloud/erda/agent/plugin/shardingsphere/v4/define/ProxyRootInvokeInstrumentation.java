...
package cloud.erda.agent.plugin.shardingsphere.v4.define;
...
public class ProxyRootInvokeInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String PROXY_ROOT_INVOKE_INTERCEPTOR_CLASS = "cloud.erda.agent.plugin.shardingsphere.v4.ProxyRootInvokeInterceptor";
