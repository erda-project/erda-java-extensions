...
public class BootstrapInstrumentBoost {
    ...
    private static String INSTANCE_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE = HIGH_PRIORITY_PLUGIN_PACKAGE + "bootstrap.template.InstanceMethodInterWithOverrideArgsTemplate";
    private static String CONSTRUCTOR_DELEGATE_TEMPLATE = HIGH_PRIORITY_PLUGIN_PACKAGE + "bootstrap.template.ConstructorInterTemplate";
    private static String STATIC_METHOD_DELEGATE_TEMPLATE = HIGH_PRIORITY_PLUGIN_PACKAGE + "bootstrap.template.StaticMethodInterTemplate";
    private static String STATIC_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE = HIGH_PRIORITY_PLUGIN_PACKAGE + "bootstrap.template.StaticMethodInterWithOverrideArgsTemplate";
